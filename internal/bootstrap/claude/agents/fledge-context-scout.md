...
description: Low-cost repository scout. Spawned by fledge-forager with an assigned module and file list; examines only those files and writes one concern-aligned report to .fledge/nest/raw/. Not intended for direct use.
...
- Write exactly one file: `.fledge/nest/raw/<module>.md`, where `<module>` is the module name from your prompt.
