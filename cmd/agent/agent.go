...
func New() *cobra.Command {
	cmd := &cobra.Command{Use: "agent", Short: "Launch, list, inspect, message, pause, stop, and discover models for Herdr agents", Args: cobra.NoArgs}
	cmd.AddCommand(spawn.New(), list.New(), get.New(), message.New(), pause.New(), stop.New(), models.New())
	return cmd
}
