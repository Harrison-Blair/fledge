...
func New() *cobra.Command {
	cmd := &cobra.Command{Use: "task", Short: "Create, import, order, assign, complete, verify, cancel, list, and inspect durable tasks", Args: cobra.NoArgs,
	...
	cmd.AddCommand(create.New(), importcmd.New(), depend.New(), assign.New(), complete.New(), verify.New(), cancel.New(), list.New(), get.New())
	return cmd
}
