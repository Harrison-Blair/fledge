...
func New() *cobra.Command {
	cmd := &cobra.Command{Use: "task", Short: "Create, order, assign, complete, verify, cancel, list, and inspect durable tasks, and print brief templates", Args: cobra.NoArgs,
	...
	cmd.AddCommand(create.New(), depend.New(), assign.New(), complete.New(), verify.New(), cancel.New(), list.New(), get.New(), template.New())
	return cmd
}
