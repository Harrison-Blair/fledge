...
func New() *cobra.Command {
	var o list.Options
	var asJSON bool
	cmd := &cobra.Command{Use: "list", Short: "List a repository's checkouts with their workspace, git state, and owning agent", Args: cobra.NoArgs, RunE: func(cmd *cobra.Command, _ []string) error {
