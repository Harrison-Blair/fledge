...
Raw module reports written by `fledge-context-scout` to `.fledge/context/raw/<module>.md`. Every section must be present, in this order; write `None observed.` where a section is empty.
